...
public class CastApplication {
    ...
    private final Cast.Listener castClientListener = new Cast.Listener() {
        ...
        public void onApplicationStatusChanged() {
            if (sApiClient != null) {
                Log.d(TAG, "onApplicationStatusChanged: " + Cast.CastApi.getApplicationStatus(sApiClient));
            }
        }
    ...
    private void createMediaPlayer() {
        ...
        try {
            Cast.CastApi.setMessageReceivedCallbacks(sApiClient, mRemoteMediaPlayer.getNamespace(), mRemoteMediaPlayer);
        } catch (IOException e) {
                    ...
                    .setResultCallback(new ResultCallback<RemoteMediaPlayer.MediaChannelResult>() {
                        ...
                        public void onResult(RemoteMediaPlayer.MediaChannelResult result) {
                            if (result.getStatus().isSuccess()) {
                                ...
                                if (mVideoFragment.isVmap() || mVideoPlayerController.getCurrentContentTime() == 0) {
                                    sendMessage("requestAd," + mAdTagUrl + "," + mVideoPlayerController.getCurrentContentTime());
                                } else {
                        ...
                        new ResultCallback<Cast.ApplicationConnectionResult>() {
                            ...
                            public void onResult(Cast.ApplicationConnectionResult result) {
                                ...
                                if (status.isSuccess()) {
                                    ...
                                    try {
                                        Cast.CastApi.setMessageReceivedCallbacks(sApiClient, NAMESPACE, incomingMsgHandler);
                                        createMediaPlayer();
                                    } catch (Exception e) {
                                        Log.e(TAG, "Exception while creating channel", e);
                                    }
                                } else {
                                    Log.e(TAG, "Connection result failed: " + status.toString());
                                }
                            }
                        }
                );
